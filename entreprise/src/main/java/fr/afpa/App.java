...
public class App {
    public static void main(String[] args) {
        ...
        Employe employe1 = new Employe("Dupont", "Michel", 2005, "Comptable", 35000, "Administration", agencePerpignan,
                true, null);
        Employe employe2 = new Employe("Smith", "John", 2010, "Manager", 31000, "Administration", agencePerpignan,
                true, enfants2);
        Employe employe3 = new Employe("Bonnet", "Marcel", 1997, "Assistant de direction", 40000, "Administration",
                agenceBrest,
                true, enfants1);
        Employe employe4 = new Employe("Pochard", "Sandrine", 1999, "RH", 33000, "Administration", agenceBrest, true,
                enfants3);
        Employe employe5 = new Employe("Chese", "Théo", 2022, "Concierge", 24000, "Services", agencePerpignan, true,
                null);
        Directeur employe6 = new Directeur("Dupont", "Jean", 2015, "Directeur", 50000, "Direction", agenceBrest, true,
                null);
